...
@RestController
@RequestMapping("/admin/certificate-types")
public class CertificateTypeController {
     ...
     */
    @PostMapping
    public ResponseVO<CertificateType> createCertificateType(@Valid @RequestBody CertificateTypeCreateVO createVO) {
        try {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseVO<Boolean> deleteCertificateType(@PathVariable Long id) {
        try {
